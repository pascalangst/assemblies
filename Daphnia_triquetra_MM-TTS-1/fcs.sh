...
python3 ~/software/ncbi-fcs/fcs.py screen genome --fasta MM-TTS-1.fa --out-dir ./gx_out/ --gx-db ~/software/ncbi-fcs/gxdb --tax-id 6668 

cat MM-TTS-1.fa | python3 ~/software/ncbi-fcs/fcs.py clean genome --action-report ./gx_out/MM-TTS-1.6668.fcs_gx_report.txt --output MM-TTS-1.clean.fasta --contam-fasta-out MM-TTS-1.contam.fasta
