...
python3 ~/software/ncbi-fcs/fcs.py screen genome --fasta CY-ORK-100.fa --out-dir ./gx_out/ --gx-db ~/software/ncbi-fcs/gxdb --tax-id 575234 

cat CY-ORK-100.fa | python3 ~/software/ncbi-fcs/fcs.py clean genome --action-report ./gx_out/CY-ORK-100.575234.fcs_gx_report.txt --output CY-ORK-100.clean.fasta --contam-fasta-out CY-ORK-100.contam.fasta
