...
python3 ~/software/ncbi-fcs/fcs.py screen genome --fasta HU-1.fa --out-dir ./gx_out/ --gx-db ~/software/ncbi-fcs/gxdb --tax-id 342845 

cat HU-1.fa | python3 ~/software/ncbi-fcs/fcs.py clean genome --action-report ./gx_out/HU-1.342845.fcs_gx_report.txt --output HU-1.clean.fasta --contam-fasta-out HU-1.contam.fasta
